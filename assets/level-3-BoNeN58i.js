...
`}),e.jsxs("p",{children:["여기서 데이터를 JSON으로 파싱하는 이유는 서버와 클라이언트가 데이터를 주고받을 때 문자만 사용 가능하기 때문이다.",e.jsx("br",{}),"JSON은 문자로 인식하기 때문에 데이터를 주고받을 때 주로 사용된다."]}),e.jsx("p",{children:"jQuery의 경우 JSON 자료가 도착하면 자동으로 Array나 Object로 변환해주지만, JavaScript의 fetch 함수는 res.json() 메서드를 사용하여 따로 변환해줘야 한다."})]})},Q=Object.freeze(Object.defineProperty({__proto__:null,default:j},Symbol.toStringTag,{value:"Module"})),b={name:"3-8 Array 관련 함수",idx:24,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"Array 관련 함수"}),e.jsx("h3",{children:"정렬 버튼 만들기"}),e.jsxs(a,{title:"정렬 버튼 코드",children:[e.jsx(t,{filename:"3-8.html",language:"html",code:`<div class="container">
...
`})]})},X=Object.freeze(Object.defineProperty({__proto__:null,default:b},Symbol.toStringTag,{value:"Module"})),f={name:"3-9 DOM 과 Load 이벤트",idx:25,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"DOM 과 Load 이벤트"}),e.jsx("h3",{children:"Document Object Model"}),e.jsxs("p",{children:["JavaScript는 HTML 문서 조작에 특화된 언어이다.",e.jsx("br",{}),"하지만 <p> 이런 식으로 HTML 태그를 직접 작성하면 알아듣지 못한다.",e.jsx("br",{}),"JavaScript가 HTML을 조작하기 위해서는 HTML을 JavaScript가 해석할 수 있는 문법으로 변환해야 한다.",e.jsx("br",{}),"그래서 브라우저는 HTML 페이지를 열 때 Object와 비슷한 자료형에 담아둔다."]}),e.jsx(t,{filename:"HTML",language:"html",code:'<div style="color : red">빨간 텍스트</div>'}),e.jsx(t,{filename:"JavaScript",language:"javascript",code:`var document = {
  ...
  // ... 수백 개의 메서드와 프로퍼티
}`}),e.jsx("p",{children:"이런건 다 알 필요는 없으니 넘어가자."})]}),e.jsx("p",{children:"그래서 아래처럼 JavaScript를 작성하면 HTML 조작이 가능한 것이다."}),e.jsx(t,{filename:"JavaScript",language:"javascript",code:'document.querySelector("div").innerHTML = "새로운 텍스트";'}),e.jsxs("p",{children:["이렇게 브라우저는 HTML 파일을 위에서 아래로 한 줄 한 줄 읽으며 DOM에 추가하거나 생성된 DOM을 변경한다.",e.jsx("br",{}),"특정 HTML을 변경하기 위해서는 해당 DOM이 생성된 이후에 스크립트가 실행되어야 가능하기 때문에 HTML 파일 맨 아래에 <script> 태그를 작성하거나 defer 속성을 사용하는 것이다."]}),e.jsx("p",{children:"아니면 아래와 같이 써도 가능은 하다."}),e.jsx(t,{filename:"JavaScript",language:"javascript",code:`$(document).ready(function () {
...
`}),e.jsx(t,{filename:"3-10-1.html",language:"html",code:`<!DOCTYPE html>
<html lang="ko">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
...
`}),e.jsx(t,{filename:"3-11-1.html",language:"html",code:`<!DOCTYPE html>
<html lang="ko">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  ...
  <body>
    ...
    <script>
      ...
      productList.forEach((i) => {
        var newproduct = \`<li>\${i.name} \${i.count}개</li>\`;

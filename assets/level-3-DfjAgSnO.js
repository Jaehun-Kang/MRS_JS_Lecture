import{j as e,F as t,C as a}from"./level-1-CmscR5WW.js";const l={name:"3-1 Array/Object",idx:17,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"Array/Object"}),e.jsx("h3",{children:"학생 카드 만들기"}),e.jsxs(t,{title:"학생 카드 코드",children:[e.jsx(a,{filename:"3-1.html",language:"html",code:`<div class="container mt-3">
  <div class="card p-3">
    <span>이름</span>
    <span>학번</span>
  </div>
...
obj[key] = newValue; // key에 해당하는 값을 newValue로 변경`}),e.jsx("p",{children:"객체는 한 사람의 이름, 학번, 전공 등 여러 가지 자료를 한 곳에 묶어 저장할 때 사용하면 좋다."})]})},w=Object.freeze(Object.defineProperty({__proto__:null,default:l},Symbol.toStringTag,{value:"Module"})),n={name:"3-10 LocalStorage",idx:26,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"LocalStorage"}),e.jsx("h3",{children:"장바구니 수강신청 만들기"}),e.jsxs(t,{title:"장바구니 수강신청 코드",children:[e.jsx(a,{filename:"3-10.html",language:"html",code:`<div class="container">
...
<\/script>`}),e.jsx(a,{filename:"3-10-1.html",language:"html",code:`<h3>장바구니</h3>
<table class="table table-striped">
  <thead>
    <tr>
      <th id="grade">학년</th>
...
`}),e.jsxs("p",{children:["장바구니 추가 버튼을 누르면 LocalStorage에 저장하고, 장바구니 보기 버튼을 누르면 장바구니 페이지를 보여준다.",e.jsx("br",{}),"이미 장바구니에 추가된 강의는 저장되지 않는다."]})]}),e.jsx("h3",{children:"브라우저 저장공간"}),e.jsx("p",{children:"개발자 도구의 Application 텝에 들어가보면 여러 종류의 저장공간이 있다."}),e.jsxs("p",{children:["- Local Storage / Session Storage",e.jsx("br",{}),"{ key : value } 형태로 문자, 숫자 데이터 저장 가능"]}),e.jsxs("p",{children:["- IndexedDB",e.jsx("br",{}),"크고 많은 구조화된 데이터 저장 가능"]}),e.jsxs("p",{children:["- Cookies",e.jsx("br",{}),"유저 인증 정보 저장에 주로 사용"]}),e.jsxs("p",{children:["- Cache Storage",e.jsx("br",{}),"HTML, CSS, JS, IMG 파일 저장 가능"]}),e.jsxs("p",{children:["Local Storage / Session Storage는 문자, 숫자 데이터만 key : value 형태로 저장이 가능하고, 5MB 용량 제한이 있다.",e.jsx("br",{}),"Local Storage는 브라우저를 닫아도 데이터가 유지되지만, Session Storage는 브라우저를 닫으면 데이터가 삭제된다."]}),e.jsx("h3",{children:"Local Storage"}),e.jsx(a,{filename:"JavaScript",language:"javascript",code:`localStorage.setItem("key", value) // 저장
localStorage.getItem("key") // 불러오기
localStorage.removeItem("key") // 삭제
localStorage.clear() // 전체 삭제
`}),e.jsx("p",{children:"문자, 숫자만 저장할 수 있다."}),e.jsx("h3",{children:"배열과 객체 저장/불러오기"}),e.jsxs("p",{children:["Array/Object를 그냥 저장하면 강제로 문자열로 변환하여 저장하는데, 자료가 깨질 위험이 있다.",e.jsx("br",{}),".stringify()를 사용하여 JSON으로 변환 후 저장하면 안전하게 저장할 수 있다."]}),e.jsx(a,{filename:"JavaScript",language:"javascript",code:`var arr = [value, value, value];
var newArr = JSON.stringify(arr); // 배열을 JSON 문자열로 변환

localStorage.setItem("key", newArr); // 변환한 문자열 localStorage에 저장
`}),e.jsxs("p",{children:["저장할 때 문자열로 변환하여 저장했으니 불러오면 문자열 상태이다.",e.jsx("br",{}),".parse()를 사용하여 다시 배열/객체로 변환해주어야 한다."]}),e.jsx(a,{filename:"JavaScript",language:"javascript",code:`var load = localStorage.getItem("key");
load = JSON.parse(load); // JSON 문자열을 다시 배열/객체로 변환
`}),e.jsx("h3",{children:".siblings()"}),e.jsx(a,{filename:"JavaScript",language:"javascript",code:`$("element").siblings(); // 모든 형제 요소 선택
...
`})]})},E=Object.freeze(Object.defineProperty({__proto__:null,default:n},Symbol.toStringTag,{value:"Module"})),s={name:"3-11 LocalStorage 응용",idx:27,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"LocalStorage 응용"}),e.jsx("h3",{children:"플리마켓 장바구니 만들기"}),e.jsxs(t,{title:"플리마켓 장바구니 코드",children:[e.jsx(a,{filename:"3-11.html",language:"html",code:`<div class="container">
  <div class="row"></div>
</div>
...
<script>
  ...
  makeCards(products);
<\/script>
`}),e.jsx(a,{filename:"3-11-1.html",language:"html",code:`<h3>장바구니</h3>
<ul class="list"></ul>
...
<\/script>
`}),e.jsx("p",{children:"같은 상품을 여러 개 추가하면 상품 개수가 증가한다."})]})]})},P=Object.freeze(Object.defineProperty({__proto__:null,default:s},Symbol.toStringTag,{value:"Module"})),r={name:"3-12 스크롤 애니메이션",idx:28,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"스크롤 애니메이션"}),e.jsx("h3",{children:"스크롤 애니메이션 만들기"}),e.jsxs(t,{title:"스크롤 애니메이션 코드",children:[e.jsx(a,{filename:"3-12.html",language:"html",code:`<div class="card-bg">
  <div class="card-box">
...
`}),e.jsx(a,{filename:"3-12.css",language:"css",code:`.card-bg {
  height: 2000px;
  margin-top: 400px;
...
`}),e.jsx("p",{children:"스크롤바를 내리면 이미지가 서서히 작아지며 사라진다."})]}),e.jsx("h3",{children:"스크롤 애니메이션"}),e.jsx("p",{children:"어떤 애니메이션이든 시작 부분과 끝 부분을 만들고 연결해주면 된다."}),e.jsx(a,{filename:"Javascript",language:"javascript",code:`$(window).scroll(function () {
  var scrollH = $(window).scrollTop(); // 현재 스크롤된 높이 값
});
`}),e.jsx("p",{children:"스크롤 애니메이션은 계산을 조금 해야한다."}),e.jsx(a,{filename:"Javascript",language:"javascript",code:`value1 = a * scrollY1 + b; // 애니메이션 시작 위치값
value2 = a * scrollY2 + b; // 애니메이션 끝 위치값
`}),e.jsx("p",{children:"value 부분에는 opacity, scale 등 원하는 CSS 속성값(숫자)을 넣고, 애니메이션을 시작할 스크롤 위치와 끝나는 스크롤 위치를 지정해주면 된다."}),e.jsx(a,{filename:"Javascript",language:"javascript",code:`$(window).scroll(function () {
  var property = a * $(window).scrollTop() + b; // 위에서 구한 a, b 값 사용
  $("element").css("property", property); // property 부분에 원하는 CSS 속성 넣기
});
`})]})},H=Object.freeze(Object.defineProperty({__proto__:null,default:r},Symbol.toStringTag,{value:"Module"})),c={name:"3-13 마우스 이벤트",idx:29,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"마우스 이벤트"}),e.jsx("h3",{children:"캐러셀 스와이프 만들기"}),e.jsxs(t,{title:"캐러셀 스와이프 코드",children:[e.jsx(a,{filename:"3-13.html",language:"html",code:`<div style="overflow: hidden">
...
`}),e.jsx("p",{children:"스와이프하면 다음 슬라이드로 넘어간다."})]}),e.jsx("h3",{children:"마우스 이벤트"}),e.jsx(a,{filename:"JavaScript",language:"javascript",code:`$("element").on("mousedown", function () { 
...
`}),e.jsx("p",{children:"마우스 클릭, 드래그 등 이벤트를 처리할 수 있다."}),e.jsx(a,{filename:"JavaScript",language:"javascript",code:`$("element").on("mousemove", function (e) {
  e.clientX; // 마우스의 x 좌표
  e.clientY; // 마우스의 y 좌표
});
`}),e.jsx("p",{children:"이렇게 마우스의 좌표도 구할 수 있다."}),e.jsx("h3",{children:"터치 이벤트"}),e.jsx("p",{children:"터치 이벤트는 아래와 같이 처리할 수 있다."}),e.jsx(a,{filename:"JavaScript",language:"javascript",code:`$("element").on("touchstart", function () { 
...
`}),e.jsx("h3",{children:"포인터 이벤트"}),e.jsxs("p",{children:["포인터 이벤트는 마우스, 터치, 스타일러스 등 다양한 입력 장치를 통합하여 처리할 수 있다.",e.jsx("br",{}),"이를 통해 마우스, 터치 이벤트를 통합할 수 있다."]}),e.jsx(a,{filename:"JavaScript",language:"javascript",code:`$("element").on("pointerdown", function () { 
...
`}),e.jsx("p",{children:"하지만 이 방법은 개발자 도구 Device Toolbar에서 터치 이벤트를 똑같이 구현하지 못하기 때문에 실제 터치 기기에서 테스트하는 것이 좋다."})]})},z=Object.freeze(Object.defineProperty({__proto__:null,default:c},Symbol.toStringTag,{value:"Module"})),i={name:"3-14 Switch 문법",idx:30,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"Switch 문법"}),e.jsx("h3",{children:"심리테스트 만들기"}),e.jsxs(t,{title:"심리테스트 코드",children:[e.jsx(a,{filename:"3-14.html",language:"html",code:`<div id="quiz">
...
<\/script>
`}),e.jsx("p",{children:"답안 중 하나를 선택하면 alert로 결과가 나온다."})]}),e.jsx("h3",{children:"Switch 조건문"}),e.jsx(a,{filename:"JavaScript",language:"javascript",code:`switch (variable) {
  case value1 :
...
}`}),e.jsx("p",{children:"아래 If/Else 문과 같은 기능을 한다."}),e.jsx(a,{filename:"JavaScript",language:"javascript",code:`if (variable === value1) {
  // variable 값이 value1과 같을 때 실행할 코드
} else if (variable === value2) {
  // variable 값이 value2과 같을 때 실행할 코드
} else {
  // case 값과 일치하는 것이 없을 때 실행할 코드
}`}),e.jsx("p",{children:"If/Else 문과 비슷하지만, 값에 따른 조건분기를 만들고 싶을 때 여러 경우를 간결하게 처리할 수 있다."})]})},A=Object.freeze(Object.defineProperty({__proto__:null,default:i},Symbol.toStringTag,{value:"Module"})),o={name:"3-2 Array/Object 응용",idx:18,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"Array/Object 응용"}),e.jsx("h3",{children:"강의 카드 만들기"}),e.jsxs(t,{title:"강의 카드 코드",children:[e.jsx(a,{filename:"3-2.html",language:"html",code:`<div class="card-group container">
  <div class="card">
    <div class="card-body">
      <h5>수업명</h5>
      <p>교수명 : ○○○</p>
...
`})]})},C=Object.freeze(Object.defineProperty({__proto__:null,default:o},Symbol.toStringTag,{value:"Module"})),d={name:"3-3 Select",idx:19,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"Select"}),e.jsx("h3",{children:"상품 선택 폼 만들기"}),e.jsxs(t,{title:"상품 선택 폼 코드",children:[e.jsx(a,{filename:"3-3.html",language:"html",code:`<form class="container my-5 form-group">
    <p>상품선택</p>
...
`})]})},R=Object.freeze(Object.defineProperty({__proto__:null,default:j},Symbol.toStringTag,{value:"Module"})),u={name:"3-5 Select 3",idx:21,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"Select 3"}),e.jsx("h3",{children:"ForEach 반복문"}),e.jsx("p",{children:"배열 형식의 데이터를 사용하여 HTML 요소를 반복 생성해보자."}),e.jsx(a,{filename:"JavaScript",language:"javascript",code:`var arr = [value, value, value];
...
`}),e.jsxs("p",{children:["하지만 일반 함수와 화살표 함수에서 this가 다르게 동작한다.",e.jsx("br",{}),"그러니 이벤트 리스너에서 화살표 함수를 사용한다면 this가 의도한 대로 동작하지 않을 수 있다."]})]})},D=Object.freeze(Object.defineProperty({__proto__:null,default:u},Symbol.toStringTag,{value:"Module"})),p={name:"3-6 Array / For 실습",idx:22,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"Array / For 실습"}),e.jsxs(t,{title:"퀴즈",children:[e.jsx(a,{filename:"1. 출석부",language:"javascript",code:`const rollBook = ["제헌", "영민", "현민", "채이", "수빈", "지현", "현서", "은별", "지윤", "시현"];
...
`})]})]})},U=Object.freeze(Object.defineProperty({__proto__:null,default:p},Symbol.toStringTag,{value:"Module"})),v={name:"3-7 Ajax",idx:23,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"Ajax"}),e.jsx("h3",{children:"강의 목록 만들기"}),e.jsxs(t,{title:"강의 목록 코드",children:[e.jsx(a,{filename:"3-7.html",language:"html",code:`<div class="container">
  <div class="row">
    <div class="col-sm-4">
      <h5>Card title</h5>
      <p>교수명 : ○○○</p>
...
`}),e.jsxs("p",{children:["여기서 데이터를 JSON으로 파싱하는 이유는 서버와 클라이언트가 데이터를 주고받을 때 문자만 사용 가능하기 때문이다.",e.jsx("br",{}),"JSON은 문자로 인식하기 때문에 데이터를 주고받을 때 주로 사용된다."]}),e.jsx("p",{children:"jQuery의 경우 JSON 자료가 도착하면 자동으로 Array나 Object로 변환해주지만, JavaScript의 fetch 함수는 res.json() 메서드를 사용하여 따로 변환해줘야 한다."})]})},V=Object.freeze(Object.defineProperty({__proto__:null,default:v},Symbol.toStringTag,{value:"Module"})),h={name:"3-8 Array 관련 함수",idx:24,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"Array 관련 함수"}),e.jsx("h3",{children:"정렬 버튼 만들기"}),e.jsxs(t,{title:"정렬 버튼 코드",children:[e.jsx(a,{filename:"3-8.html",language:"html",code:`<div class="container">
  <button class="btn btn-danger" id="more">더보기</button>
...
`}),e.jsxs("p",{children:["window에다 붙이면 document에 포함된 이미지, CSS, JS 파일 포함 전부 로드가 되었는지 확인 가능하다.",e.jsx("br",{}),"앞서 설명했던 .ready()는 DOM 생성만 확인하는 함수이고, 이건 모든 파일과 이미지의 로드까지 확인한다는 차이가 있다."]}),e.jsx("h3",{children:"React/Vue"}),e.jsxs("p",{children:["위에서 설명했듯 JavaScript만으로는 변수가 바뀐 후 HTML에 반영하고 싶다면 변수 변경을 감지한 후 그걸 기존 HTML에 반영하라는 코드를 따로 작성해줘야 한다.",e.jsx("br",{}),"React나 Vue는 JavaScript 변수가 바뀌면 그걸 HTML에 자동으로 반영해주는 라이브러리라 더욱 편리하기 때문에 많이 사용하는 것이다."]})]})},G=Object.freeze(Object.defineProperty({__proto__:null,default:g},Symbol.toStringTag,{value:"Module"})),m={name:"3-1",idx:18,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"3-1"}),e.jsx(a,{filename:"3-1.html",language:"html",code:""})]})},B=Object.freeze(Object.defineProperty({__proto__:null,default:m},Symbol.toStringTag,{value:"Module"})),x={name:"3-10",idx:27,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"3-10"}),e.jsx(a,{filename:"3-10.html",language:"html",code:""})]})},q=Object.freeze(Object.defineProperty({__proto__:null,default:x},Symbol.toStringTag,{value:"Module"})),b={name:"3-11",idx:28,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"3-11"}),e.jsx(a,{filename:"3-11.html",language:"html",code:""})]})},Q=Object.freeze(Object.defineProperty({__proto__:null,default:b},Symbol.toStringTag,{value:"Module"})),_={name:"3-12",idx:29,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"3-12"}),e.jsx(a,{filename:"3-12.html",language:"html",code:""})]})},Y=Object.freeze(Object.defineProperty({__proto__:null,default:_},Symbol.toStringTag,{value:"Module"})),f={name:"3-13",idx:30,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"3-13"}),e.jsx(a,{filename:"3-13.html",language:"html",code:""})]})},X=Object.freeze(Object.defineProperty({__proto__:null,default:f},Symbol.toStringTag,{value:"Module"})),S={name:"3-14",idx:31,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"3-14"}),e.jsx(a,{filename:"3-14.html",language:"html",code:""})]})},K=Object.freeze(Object.defineProperty({__proto__:null,default:S},Symbol.toStringTag,{value:"Module"})),y={name:"3-2",idx:19,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"3-2"}),e.jsx(a,{filename:"3-2.html",language:"html",code:""})]})},W=Object.freeze(Object.defineProperty({__proto__:null,default:y},Symbol.toStringTag,{value:"Module"})),O={name:"3-3",idx:20,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"3-3"}),e.jsx(a,{filename:"3-3.html",language:"html",code:""})]})},Z=Object.freeze(Object.defineProperty({__proto__:null,default:O},Symbol.toStringTag,{value:"Module"})),L={name:"3-4",idx:21,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"3-4"}),e.jsx(a,{filename:"3-4.html",language:"html",code:""})]})},ee=Object.freeze(Object.defineProperty({__proto__:null,default:L},Symbol.toStringTag,{value:"Module"})),T={name:"3-5",idx:22,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"3-5"}),e.jsx(a,{filename:"3-5.html",language:"html",code:""})]})},ae=Object.freeze(Object.defineProperty({__proto__:null,default:T},Symbol.toStringTag,{value:"Module"})),J={name:"3-6",idx:23,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"3-6"}),e.jsx(a,{filename:"3-6.html",language:"html",code:""})]})},te=Object.freeze(Object.defineProperty({__proto__:null,default:J},Symbol.toStringTag,{value:"Module"})),M={name:"3-7",idx:24,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"3-7"}),e.jsx(a,{filename:"3-7.html",language:"html",code:""})]})},le=Object.freeze(Object.defineProperty({__proto__:null,default:M},Symbol.toStringTag,{value:"Module"})),N={name:"3-8",idx:25,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"3-8"}),e.jsx(a,{filename:"3-8.html",language:"html",code:""})]})},ne=Object.freeze(Object.defineProperty({__proto__:null,default:N},Symbol.toStringTag,{value:"Module"})),k={name:"3-9",idx:26,level:3,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"3-9"}),e.jsx(a,{filename:"3-9.html",language:"html",code:""})]})},se=Object.freeze(Object.defineProperty({__proto__:null,default:k},Symbol.toStringTag,{value:"Module"}));export{B as A,G as _,F as a,V as b,U as c,D as d,R as e,I as f,C as g,A as h,z as i,H as j,P as k,E as l,w as m,se as n,ne as o,le as p,te as q,ae as r,ee as s,Z as t,W as u,K as v,X as w,Y as x,Q as y,q as z};

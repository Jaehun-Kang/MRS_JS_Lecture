...
num = num % 2; // 나머지
num %= 2;
`}),e.jsx("p",{children:"축약형 연산자를 사용하면 연산과 할당을 동시에 할 수 있다."}),e.jsxs(a,{title:"퀴즈",children:[e.jsx(s,{filename:"1. 나이와 출생년도",language:"javascript",code:`// 나이와 출생년도를 저장하는 변수를 각각 생성하라.
...
`}),e.jsx("p",{children:"왼쪽, 1, 2, 3, 오른쪽 버튼을 누르면 애니메이션 효과와 함께 슬라이드가 이동한다."}),e.jsx(n,{title:"첨부파일 (assets 폴더에 넣기)",items:[{alt:"car1.png",src:t},{alt:"car2.png",src:l},{alt:"car3.png",src:i}]})]}),e.jsx("h3",{children:"애니메이션 UI 만들기 순서"}),e.jsxs("p",{children:["1. 애니메이션 시작 전 화면 HTML/CSS 구성",e.jsx("br",{}),"2. 애니메이션 종료 후 화면 HTML/CSS 구성",e.jsx("br",{}),"3. 애니메이션 시작 시점 JavaScript 구현",e.jsx("br",{}),"4. transition CSS 추가"]})]})},j={name:"2-5 Return",idx:10,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"Return"}),e.jsx("h3",{children:"Return"}),e.jsx("p",{children:"return 문법은 함수에서 값을 반환할 때 사용한다."}),e.jsx(s,{filename:"JavaScript",language:"javascript",code:`function fName() {
  return value;
}
...
`}),e.jsxs(a,{title:"퀴즈",children:[e.jsx(s,{filename:"1. 밀리초 변환기",language:"javascript",code:`function toMs(min, sec) {
...
`}),e.jsx("p",{children:"100px 이상 스크롤 시 로고 사이즈가 줄어든다."}),e.jsx(n,{title:"첨부파일 (assets 폴더에 넣기)",items:[{alt:"logo.svg",src:c}]})]}),e.jsx("h3",{children:"스크롤 이벤트 리스너"}),e.jsx(s,{filename:"JavaScript",language:"javascript",code:`window.addEventListener("scroll", function () {
  // 스크롤 시 실행할 코드
});
...
`}),e.jsx("h3",{children:"스크롤 이벤트 주의할 점"}),e.jsxs("p",{children:["1. 스크롤 내린 양은 정수 단위로 나오지 않고, OS마다 부장확할 수 있기 때문에 여유를 두는 것이 좋다.",e.jsx("br",{}),"2. 스크롤 이벤트 리스너 안의 코드는 1초에 60번 이상 실행되므로 스크롤바 1개마다 1개만 부착하여 성능 저하를 방지하는 것이 좋다."]})]})},m={name:"2-7 탭메뉴",idx:12,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"탭메뉴"}),e.jsx("h3",{children:"탭메뉴 만들기"}),e.jsxs(a,{title:"탭메뉴 코드",children:[e.jsx(s,{filename:"2-8.html",language:"html",code:`<div class="container mt-5">
  <ul class="list">
...
`}),e.jsx("p",{children:"var 대신 let을 사용하는 이유는 변수의 유효 범위에 있다."})]})},u={name:"2-8 이벤트 버블링",idx:13,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"이벤트 버블링"}),e.jsx("h3",{children:"모달창 만들기"}),e.jsxs(a,{title:"모달창 코드",children:[e.jsx(s,{filename:"2-9.html",language:"html",code:`<div class="black-bg">
  <div class="white-bg">
    <h4>로그인하세요</h4>
...
`}),e.jsx("p",{children:"참고로 e.target는 자바스크립트 객체이고, $(e.target)은 jQuery 객체로 변환한 것이다."})]})},g={name:"2-9 탭메뉴 응용",idx:14,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"탭메뉴 응용"}),e.jsx("h3",{children:"탭메뉴 다시 만들기"}),e.jsxs(a,{title:"탭메뉴 코드",children:[e.jsx(s,{filename:"2-10.html",language:"html",code:`<div class="container">
  <ul class="list">
...
$("element").data('dataName') // 데이터 불러오기`}),e.jsx("p",{children:"dataset 문법은 IE 11 이상 버전에서 지원되는데, jQuery의 data() 메서드는 더 오래된 브라우저도 지원한다."})]})},v={name:"2-10 라이브러리",idx:15,content:e.jsxs("div",{className:"lesson-content",children:[e.jsx("h2",{children:"라이브러리"}),e.jsx("h3",{children:e.jsx("a",{target:"_blank",href:"https://swiperjs.com/demos",children:"Swiper"})}),e.jsx("p",{children:"캐러셀 라이브러리"}),e.jsx("h3",{children:e.jsx("a",{target:"_blank",href:"https://www.chartjs.org/docs/latest/samples/",children:"Chart.js"})}),e.jsx("p",{children:"차트 라이브러리"}),e.jsx("h3",{children:e.jsx("a",{target:"_blank",href:"https://michalsnik.github.io/aos/",children:"Animate on Scroll"})}),e.jsx("p",{children:"스크롤 애니메이션 라이브러리"}),e.jsx("h3",{children:e.jsx("a",{target:"_blank",href:"https://www.emailjs.com/docs/introduction/how-does-emailjs-work/",children:"EmailJS"})}),e.jsx("p",{children:"이메일 전송 라이브러리"}),e.jsx("h3",{children:e.jsx("a",{target:"_blank",href:"https://lodash.com/docs/4.17.15",children:"Lodash"})}),e.jsx("p",{children:"유틸리티 라이브러리(array, object, 문자, 숫자 자료를 다루기 편해지는 기본함수들을 제공)"}),e.jsxs("h3",{children:[e.jsx("a",{target:"_blank",href:"https://react.dev/",children:"React"}),"/",e.jsx("a",{target:"_blank",href:"https://play.vuejs.org/",children:"Vue"})]}),e.jsx("p",{children:"프론트엔드 프레임워크"}),e.jsx("h3",{children:e.jsx("a",{target:"_blank",href:"https://alvarotrigo.com/fullPage/",children:"Fullpage.js"})}),e.jsx("p",{children:"풀페이지 스크롤 라이브러리"})]})};export{d as L,o as a,x as b,h as c,j as d,p as e,m as f,u as g,g as h,v as i};
